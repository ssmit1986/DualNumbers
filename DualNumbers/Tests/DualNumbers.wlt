...
"Done"
	...
	"Done"	
	,
	TestID->"bbaf5d11-3f62-40b1-ba65-58d0209ef9e9"
]
...
Dual[{}, {}],Dual[{0}, {1}]
	...
	,
	{Dual[{}, {}], Dual[{1}, {0}], Dual[{{1}}, {{0}}], Dual[SparseArray[Automatic, {1}, 0, {1, {{0, 1}, {{1}}}, {1}}],    SparseArray[Automatic, {1}, 0, {1, {{0, 0}, {}}, {}}]], Dual[{}, {}], Dual[{0}, {1}]}	
	,
...
ToDual[1, {2, 3}],ToDual[1, SparseArray@{2, 3}]
	...
	,
	{Dual[1, 2], Dual[{1}, {2}], Dual[{1, 1}, {0, 2}], Dual[{1, 1}, {2, 3}], Dual[SparseArray[Automatic, {2}, 1, {1, {{0, 0}, {}}, {}}],    SparseArray[Automatic, {2}, 0, {1, {{0, 2}, {{1}, {2}}}, {2, 3}}]]}	
	,
...
StandardNonStandard[1],
StandardNonStandard[Dual[{1, 2}, {3, 4}]]
}
	,
	{{a, b}, {a, 0}, {1, 0}, {{1, 3}, {2, 4}}}	
	,
...
{Dual[0, 2], Dual[1, 3]},{Dual[0, 2], {Dual[1, 3]}},
{Dual[0, 2], 1},
{0, 1}
};
AssociationMap[DualQ, testValues]
	,
	Association[1->False, Dual[0, 1]->True, Dual[1, 0]->True, Dual[{0, 1}, {2, 3}]->True, Dual[{{0, 1}}, {{2, 3}}]->True, {Dual[0, 2], Dual[1, 3]}->False, {Dual[0, 2], {Dual[1, 3]}}->False, {Dual[0, 2], 1}->False, {0, 1}->False]	
	,
...
{
AssociationMap[#[largePackedArray]&, tests], 
AssociationMap[#[largeUnPackedArray]&, tests],
AssociationMap[#[arr]&, tests]
}
]
	,
	{Association[DualQ->True, DualScalarQ->False, StandardQ->False,    DualArrayQ->True,UnpackedDualArrayQ->False,DualFreeArrayQ->False], Association[DualQ->False, DualScalarQ->False, StandardQ->True,    DualArrayQ->False,UnpackedDualArrayQ->True,DualFreeArrayQ->False], Association[DualQ->False, DualScalarQ->False, StandardQ->True,    DualArrayQ->False,UnpackedDualArrayQ->False,DualFreeArrayQ->True]}	
	,
